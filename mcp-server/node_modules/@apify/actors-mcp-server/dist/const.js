...
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="bb09dce9-b603-55a5-9d14-a6a00f65944b")}catch(e){}}();
...
export const ACTOR_MAX_MEMORY_MBYTES = 4096;
 ...
 */
export const RETIRED_SELECTOR_NAMES = new Set(['add-actor', 'experimental', 'preview']);
/**
 ...
 */
export const REPORT_PROBLEM_BLOCKED_CLIENTS = ['claude', 'anthropic', 'local-agent-mode-apify'];
/**
...
export const DOCS_SOURCES = [
    {
        ...
        description: 'Apify Platform documentation including: Platform features, SDKs (JS, Python), CLI, ' +
    ...
    },
    {
        ...
        description: 'Crawlee is a web scraping library for JavaScript. ' +
    ...
    },
    {
        ...
        description: 'Crawlee is a web scraping library for Python. ' +
            'It handles blocking, crawling, proxies, and browsers for you.',
    },
];
/**
...
export const ALLOWED_DOC_DOMAINS = ['https://docs.apify.com', 'https://crawlee.dev'];
/** Actor usernames treated as official Apify (drives `isOfficialApify` on the Actor card). */
export const OFFICIAL_APIFY_USERNAMES = new Set([
    'agentify',
    'apify',
    'apifyatevents',
    'clockworks',
...
export const ALLOWED_TASK_TOOL_EXECUTION_MODES = ['optional', 'required'];
//# sourceMappingURL=const.js.map
//# debugId=bb09dce9-b603-55a5-9d14-a6a00f65944b
