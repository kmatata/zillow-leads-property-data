...
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="eefa770d-e982-54dd-977f-231503aee0e7")}catch(e){}}();
 ...
 */
export async function processParamsGetTools(url, apifyClient, mode = SERVER_MODE.DEFAULT, actorStore) {
 ...
 */
export async function storeTaskResultOrSkipIfExpired(taskStore, toolName, taskId, status, result, mcpSessionId) {
    try {
 ...
 */
export async function isTaskCancelled(taskId, mcpSessionId, taskStore) {
    const task = await taskStore.getTask(taskId, mcpSessionId);
    return (task === null || task === void 0 ? void 0 : task.status) === 'cancelled';
}
/**
...
export function createTaskCancellationWatcher(opts) {
    ...
    const interval = setInterval(() => {
        if (tickInProgress || controller.signal.aborted)
            return;
        tickInProgress = true;
        void (async () => {
            try {
...
//# debugId=eefa770d-e982-54dd-977f-231503aee0e7
