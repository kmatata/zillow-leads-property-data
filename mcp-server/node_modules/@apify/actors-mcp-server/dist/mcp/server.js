...
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="529d6806-45aa-580f-86b6-b1a0fe148f0c")}catch(e){}}();
 ...
 */
async function resolveServableWidgets() {
...
export class ActorsMcpServer {
    ...
    constructor(options = {}) {
         ...
         */
        Object.defineProperty(this, "_serverMode", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
         ...
         */
        Object.defineProperty(this, "pendingToolsUntilClientKnown", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Map()
         ...
         */
        Object.defineProperty(this, "toolSources", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Map()
        ...
        Object.defineProperty(this, "promptService", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "resourceService", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "availableWidgets", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Map()
         ...
         */
        Object.defineProperty(this, "widgetsResolution", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "legacyServer", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        this._clientContext = buildMcpClientContext((_a = options.initializeRequestData) === null || _a === void 0 ? void 0 : _a.params);
    ...
    setupTelemetry() {
        ...
        const explicitEnabled = parseBooleanOrNull((_a = this.options.telemetry) === null || _a === void 0 ? void 0 : _a.enabled);
        if (explicitEnabled !== null) {
            telemetryEnabled = explicitEnabled;
        }
        else {
            const envEnabled = parseBooleanOrNull(process.env.TELEMETRY_ENABLED);
            telemetryEnabled = envEnabled !== null && envEnabled !== void 0 ? envEnabled : DEFAULT_TELEMETRY_ENABLED;
        }
        // Configure telemetryEnv: explicit option > env var > default ('PROD')
        let telemetryEnv = DEFAULT_TELEMETRY_ENV;
        if (telemetryEnabled) {
            telemetryEnv = getTelemetryEnv((_c = (_b = this.options.telemetry) === null || _b === void 0 ? void 0 : _b.env) !== null && _c !== void 0 ? _c : process.env.TELEMETRY_ENV);
        }
    ...
    async applyInitialize(request) {
        ...
        log.info('Resolved server mode for client capabilities', {
            ...
            capabilities: (_a = request === null || request === void 0 ? void 0 : request.params) === null || _a === void 0 ? void 0 : _a.capabilities,
        });
     ...
     */
    getStatelessServerInstructions() {
     ...
     */
    async createRequestSnapshot(clientContext) {
        ...
        const view = { serverMode, clientContext };
     ...
     * policy.
     */
    isReportProblemServable(view) {
        return (this.telemetryEnabled && view.clientContext != null && !isReportProblemBlockedForClient(view.clientContext));
    }
    composePendingToolsForClient() {
        if (this.pendingToolsUntilClientKnown.size === 0)
            return;
        const tools = [...this.pendingToolsUntilClientKnown.values()].flatMap((source) => this.composeToolsForClient(source, this.servingContext));
    ...
    listActorMcpServerToolIds() {
        const ids = Array.from(this.tools.values())
            .filter((tool) => tool.type === TOOL_TYPE.ACTOR_MCP)
     ...
     */
    registerFetchedActorTools(input, actorTools) {
        const source = { input, actorTools };
     ...
     */
    resolveApifyToken(meta) {
        return (meta === null || meta === void 0 ? void 0 : meta.apifyToken) || this.options.token;
    }
    /**
    ...
    createApifyClient(token, clientContext) {
     ...
     */
    async resolveWidgetsForMode(mode) {
        var _a;
        ...
        const resolution = ((_a = this.widgetsResolution) !== null && _a !== void 0 ? _a : (this.widgetsResolution = resolveServableWidgets().catch((error) => {
...
//# debugId=529d6806-45aa-580f-86b6-b1a0fe148f0c
