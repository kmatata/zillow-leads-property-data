...
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="0aa9e843-7b66-5ea6-9fd1-01e53c6d130a")}catch(e){}}();
...
export async function dispatchToolCall(params) {
    var _a, _b, _c;
    const { tool, toolArgs, logSafeArgs, apifyToken, apifyClient, mcpSessionId, progressToken, progressTracker, shouldForwardNotifications, signal, sendNotification, emitLog, actorStore, paymentProvider, tools, actorName, actorId, taskMode, logContext, } = params;
    let result = {};
    ...
    switch (tool.type) {
        case TOOL_TYPE.INTERNAL: {
            try {
                log.info(`Calling internal tool${(_a = logContext === null || logContext === void 0 ? void 0 : logContext.messageSuffix) !== null && _a !== void 0 ? _a : ''}`, {
                    ...logContext === null || logContext === void 0 ? void 0 : logContext.fields,
                    toolName: tool.name,
                    mcpSessionId,
                    input: logSafeArgs,
                });
        ...
        case TOOL_TYPE.ACTOR_MCP: {
            ...
            try {
                ...
                log.info(`Calling Actor-MCP${(_b = logContext === null || logContext === void 0 ? void 0 : logContext.messageSuffix) !== null && _b !== void 0 ? _b : ''}`, {
                    ...logContext === null || logContext === void 0 ? void 0 : logContext.fields,
                    toolName: tool.name,
                ...
                result = respondErrorNoTelemetry(`Failed to call MCP tool '${tool.originToolName}' on Actor '${tool.actorId}': ${remoteMcpFailureDetail(error)}`);
            }
            finally {
                if (client)
                    await client.close();
        ...
        case TOOL_TYPE.ACTOR: {
            try {
                log.info(`Calling Actor${(_c = logContext === null || logContext === void 0 ? void 0 : logContext.messageSuffix) !== null && _c !== void 0 ? _c : ''}`, {
                    ...logContext === null || logContext === void 0 ? void 0 : logContext.fields,
                    toolName: tool.name,
                ...
                ({ toolStatus, callDiagnostics } = applyToolTelemetry(executorResult, actorName, actorId, callDiagnostics));
...
//# sourceMappingURL=tool_dispatch.js.map
//# debugId=0aa9e843-7b66-5ea6-9fd1-01e53c6d130a
