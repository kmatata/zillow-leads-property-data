...
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="f905d977-87c6-52de-8d12-0a86e0447d19")}catch(e){}}();
import log from '@apify/log';
import { defaults, HELPER_TOOLS, RETIRED_SELECTOR_NAMES } from '../const.js';
import { reportProblem } from '../tools/dev/report_problem.js';
import { getActorsAsTools } from '../tools/index.js';
import { CATEGORY_NAME_SET, CATEGORY_NAMES, getCategoryTools, toolCategoriesEnabledByDefault, WIDGET_BY_BASE_TOOL, } from '../tools/registry.js';
 ...
 */
export const AUTO_INJECTED_TOOLS = [
    getActorRun,
    getDatasetItems,
...
function resolveActorsToLoad(input) {
    ...
    if (selectors !== undefined) {
        for (const sel of selectors) {
            if (RETIRED_SELECTOR_NAMES.has(sel))
                continue;
 ...
 */
export async function getActors(input, apifyClient, options) {
...
export function toolNamesToInput(toolNames) {
    ...
    for (const toolName of toolNames) {
        ...
        if (RETIRED_SELECTOR_NAMES.has(toolName))
            continue;
 ...
 */
export function getToolsForServerMode(input, actorTools, mode = SERVER_MODE.DEFAULT) {
...
export async function loadToolsFromInput(input, apifyClient, mode = SERVER_MODE.DEFAULT, actorStore) {
...
//# debugId=f905d977-87c6-52de-8d12-0a86e0447d19
