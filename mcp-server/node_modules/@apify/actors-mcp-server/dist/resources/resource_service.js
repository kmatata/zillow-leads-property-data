...
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="5aac376b-c461-5ad2-b2b9-395cad93766b")}catch(e){}}();
...
export function createResourceService(options) {
    ...
    const listResources = async () => {
        var _a;
        const resources = [];
        if ((_a = paymentProvider === null || paymentProvider === void 0 ? void 0 : paymentProvider.getUsageGuide) === null || _a === void 0 ? void 0 : _a.call(paymentProvider)) {
            resources.push({
                uri: 'file://readme.md',
                name: 'readme',
    ...
    const readResource = async (uri, apifyClient) => {
        var _a;
        ...
        if (/^https?:\/\//i.test(uri)) {
            ...
            return (await readApiResource(uri, apifyClient));
        }
        const usageGuide = (_a = paymentProvider === null || paymentProvider === void 0 ? void 0 : paymentProvider.getUsageGuide) === null || _a === void 0 ? void 0 : _a.call(paymentProvider);
            ...
            resourceTemplates: [
                {
                    ...
                    description: 'Items of a dataset, read via resources/read (the server injects the Apify token). ' +
                ...
                },
                {
                    ...
                    description: 'A single record, returned whole in its stored Content-Type via resources/read. ' +
...
//# debugId=5aac376b-c461-5ad2-b2b9-395cad93766b
