...
import type { Actor as ActorOutdated, ActorDefaultRunOptions, ActorDefinition, ActorRunPricingInfo, ActorStats, ActorStoreList as ActorStoreListOutdated } from 'apify-client';
 ...
 */
export type ActorDefinitionPruned = Pick<ActorDefinitionWithDesc, 'id' | 'actorFullName' | 'buildTag' | 'readme' | 'readmeSummary' | 'input' | 'description' | 'defaultRunOptions'> & {
...
export declare const ALL_TOOLS_PRESENT: ToolDescriptionContext;
/**
 ...
 */
export type ReportedProblemTelemetryProperties = Pick<ToolCallTelemetryProperties, 'app' | 'app_version' | 'mcp_client_name' | 'mcp_client_version' | 'mcp_protocol_version' | 'mcp_session_id' | 'transport_type'> & {
    message: string;
    actor_id?: string;
    actor_run_id?: string;
    related_tools?: string[];
};
export type AjvErrorDetails = Pick<ToolCallTelemetryProperties, 'validation_keyword' | 'validation_path' | 'validation_missing_property' | 'validation_additional_property' | 'validation_error_count'>;
/**
...
export type CallDiagnostics = Pick<ToolCallTelemetryProperties, 'failure_category' | 'failure_http_status' | 'failure_detail' | 'actor_name' | 'actor_id' | 'run_id' | 'run_status' | 'dataset_id' | 'key_value_store_id' | 'validation_keyword' | 'validation_path' | 'validation_missing_property' | 'validation_additional_property' | 'validation_error_count'>;
/**
 ...
 */
export declare const SERVER_MODE: {
...
export declare const SERVER_MODES: readonly SERVER_MODE[];
/**
