...
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="ec6468cc-b614-5676-8bd9-3388924d9891")}catch(e){}}();
import { expect } from 'vitest';
import { actorNameToToolName, defaults, getCategoryTools, getExpectedToolNamesByCategories, } from '@apify/actors-mcp-server/internals.js';
import { HELPER_TOOLS } from '@apify/actors-mcp-server/internals/test-kit.js';
import { ACTOR_NORMAL_MODE, AUTO_INJECTED_TOOL_NAMES, DEFAULT_ACTOR_NAMES, expectToolNamesToContain, expectWidgetToolMeta, getToolNames, RETIRED_SELECTORS, servedDefaultTools, servedDefaultToolNames, skipUnlessStdio, withClient, } from '../helpers.js';
...
const DOCS_RUNS_STORAGE_CATEGORIES = ['docs', 'runs', 'storage'];
...
export const registrationCases = [
    ...
    },
    {
        ...
        run: withClient({ actors: TWO_TEST_ACTORS, serverMode: 'default' }, async (client) => {
            ...
            expectToolNamesToContain(names, TWO_TEST_ACTORS.map((actor) => actorNameToToolName(actor)));
            expectToolNamesToContain(names, AUTO_INJECTED_TOOL_NAMES);
        }),
    },
    {
    ...
    },
    {
        ...
        run: withClient({ tools: SINGLE_NORMAL_MODE_ACTOR }, async (client, ctx) => {
            ...
            if (ctx.transport !== '2026-07-28') {
                ...
                expect(normalModeTool === null || normalModeTool === void 0 ? void 0 : normalModeTool.execution).toBeDefined();
            }
            else {
    ...
    ...Object.keys(getCategoryTools('default'))
        ...
        isDeploymentTest: false,
        run: withClient({ tools: [category] }, async (client) => {
            const loadedTools = await client.listTools();
            const toolNames = getToolNames(loadedTools);
            const expectedToolNames = getExpectedToolNamesByCategories([category]);
...
//# sourceMappingURL=registration.cases.js.map
//# debugId=ec6468cc-b614-5676-8bd9-3388924d9891
