...
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="ad4988bb-d796-5796-a725-df33bfb4251b")}catch(e){}}();
import { expect } from 'vitest';
import { HELPER_TOOLS, RESOURCE_MIME_TYPE, SERVER_MODE_AUTO_DETECTION_ENABLED, } from '@apify/actors-mcp-server/internals/test-kit.js';
...
export const appsCases = [
    ...
    },
    {
        ...
        run: withClient(undefined, async (client) => {
            ...
            for (const toolName of [
                ...
                expect((_a = tool === null || tool === void 0 ? void 0 : tool._meta) === null || _a === void 0 ? void 0 : _a.ui).toBeUndefined();
            }
        }),
    },
    {
        ...
        run: withClient({ tools: ['actors'], serverMode: 'apps' }, async (client) => {
            ...
            expect(Array.isArray((_a = content.structuredContent) === null || _a === void 0 ? void 0 : _a.actors)).toBe(true);
            // Check widgetActors presence in apps mode
            expect(Array.isArray((_b = content.structuredContent) === null || _b === void 0 ? void 0 : _b.widgetActors)).toBe(true);
    ...
    },
    {
        ...
        run: withClient({ tools: ['actors'], serverMode: 'apps' }, async (client) => {
            ...
            const content = result;
            expect(content.structuredContent).toBeDefined();
            expect((_a = content.structuredContent) === null || _a === void 0 ? void 0 : _a.actorDetails).toBeDefined();
...
//# sourceMappingURL=apps.cases.js.map
//# debugId=ad4988bb-d796-5796-a725-df33bfb4251b
