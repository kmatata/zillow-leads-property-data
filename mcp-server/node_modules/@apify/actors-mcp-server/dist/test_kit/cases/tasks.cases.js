...
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="249fc1d7-b71d-5938-b025-f991512a3fe7")}catch(e){}}();
...
export const tasksCases = [
    {
        ...
        run: async (ctx) => {
            ...
            const client = (await ctx.createClientFn({ actors: [ACTOR_NORMAL_MODE] }));
            try {
                ...
                }, CallToolResultSchema, { signal: controller.signal, onprogress })
    ...
    },
    {
        ...
        retry: 1,
        run: async (ctx) => {
            const client = (await ctx.createClientFn({ tools: ['actors'] }));
            try {
                const api = ctx.createApifyClient();
                const controller = new AbortController();
                const { onprogress, runIdPromise } = captureRunIdFromProgress();
    ...
    },
    {
        ...
        skipIf: lacksTaskSupport,
        run: async (ctx) => {
            const client = (await ctx.createClientFn({ tools: [ACTOR_NORMAL_MODE] }));
            try {
                ...
                }, CallToolResultSchema, { task: { ttl: 60000 } });
                let lastStatus = '';
            ...
            try {
                ...
                for await (const message of stream) {
                    if (message.type === 'taskCreated') {
                        ...
                        if (!taskId)
                            throw new Error('Task ID should be set before receiving result');
        ...
        run: async (ctx) => {
            ...
            try {
                ...
                const stream = client.experimental.tasks.callToolStream({
                    ...
                    arguments: { firstNumber: 1, secondNumber: 2, waitSeconds: 60 },
                }, CallToolResultSchema, { task: { ttl: 60000 }, onprogress });
                let cancelled = false;
                for await (const message of stream) {
                    if (message.type === 'taskCreated') {
...
//# sourceMappingURL=tasks.cases.js.map
//# debugId=249fc1d7-b71d-5938-b025-f991512a3fe7
