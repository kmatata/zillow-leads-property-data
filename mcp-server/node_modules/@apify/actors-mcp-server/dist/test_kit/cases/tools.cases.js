...
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="e4bdbb82-25be-55e8-92dd-a1904553ad4c")}catch(e){}}();
import { expect } from 'vitest';
import { CALL_ACTOR_MCP_MISSING_TOOL_NAME_MSG, HELPER_TOOLS } from '@apify/actors-mcp-server/internals/test-kit.js';
import { ACTOR_EXAMPLE_MCP_SERVER, buildExampleMcpServerAddToolContent, getToolNames, skipUnlessLegacyHttp, validateStructuredOutputForTool, withClient, } from '../helpers.js';
/** Protocol/tool behavior: prompts, docs, report-problem, schemas, MCP passthrough. */
export const toolsCases = [
    {
    ...
    },
    {
        ...
        run: withClient(undefined, async (client) => {
            ...
            expect(typeof (searchApiifyDocsTool === null || searchApiifyDocsTool === void 0 ? void 0 : searchApiifyDocsTool.outputSchema)).toBe('object');
            expect(searchApiifyDocsTool === null || searchApiifyDocsTool === void 0 ? void 0 : searchApiifyDocsTool.outputSchema).toHaveProperty('type');
            expect(searchApiifyDocsTool === null || searchApiifyDocsTool === void 0 ? void 0 : searchApiifyDocsTool.outputSchema).toHaveProperty('properties');
        }),
    },
    {
        ...
        run: withClient({ tools: ['actors'] }, async (client) => {
            ...
            expect((_a = callResult.isError) !== null && _a !== void 0 ? _a : false).toBe(false);
        }),
    },
    {
    ...
    },
    {
        ...
        run: withClient(undefined, async (client) => {
            await client.listTools();
            await expect(client.transport.terminateSession()).resolves.toBeUndefined();
        }),
    },
    {
...
//# sourceMappingURL=tools.cases.js.map
//# debugId=e4bdbb82-25be-55e8-92dd-a1904553ad4c
