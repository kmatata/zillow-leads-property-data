...
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="1bda4be1-7c24-5966-a2ed-4d1f871fc17c")}catch(e){}}();
...
import { ACTOR_EXAMPLE_MCP_SERVER, ACTOR_NORMAL_MODE, AUTO_INJECTED_TOOL_NAMES, expectNormalModeTestStructuredContent, expectReadmeInStructuredContent, expectToolNamesToContain, expectUsageCostMeta, findToolByName, getToolNames, validateStructuredOutput, validateStructuredOutputForTool, withClient, } from '../helpers.js';
...
export const actorsCases = [
    ...
    },
    {
        ...
        run: withClient({ tools: ['actors'] }, async (client) => {
            ...
            expect((_a = content[0]) === null || _a === void 0 ? void 0 : _a.type).toBe('text');
            const mirrored = JSON.parse(content[0].text);
    ...
    },
    {
        ...
        run: withClient({ tools: ['actors'] }, async (client) => {
            ...
            await expect(client.callTool({ name: HELPER_TOOLS.ACTOR_CALL, arguments: { actor: ACTOR_NORMAL_MODE } })).rejects.toThrow(/must have required property 'input'/);
    ...
    },
    {
        ...
        run: withClient({ tools: ['actors'] }, async (client) => {
            ...
            expect(sc === null || sc === void 0 ? void 0 : sc.status).toBe('SUCCEEDED');
            expect(sc === null || sc === void 0 ? void 0 : sc.summary).toMatch(/SUCCEEDED/);
    ...
    },
    {
        ...
        run: withClient({ tools: ['actors'] }, async (client) => {
            ...
            validateStructuredOutputForTool(callResult, HELPER_TOOLS.ACTOR_CALL, 'default');
            const sc = callResult.structuredContent;
            expect(sc === null || sc === void 0 ? void 0 : sc.runId).toBeDefined();
            // Non-blocking: status is typically READY or RUNNING at this point (terminal also tolerated for very fast actors).
            expect(['READY', 'RUNNING', 'SUCCEEDED']).toContain(sc === null || sc === void 0 ? void 0 : sc.status);
        }),
    },
    {
    ...
    },
    {
        ...
        run: withClient({ tools: ['actors'] }, async (client) => {
            ...
            const sc = callResult.structuredContent;
            expect(sc === null || sc === void 0 ? void 0 : sc.status).toBe('SUCCEEDED');
            expect((_c = (_b = (_a = sc === null || sc === void 0 ? void 0 : sc.storages) === null || _a === void 0 ? void 0 : _a.datasets) === null || _b === void 0 ? void 0 : _b.default) === null || _c === void 0 ? void 0 : _c.id).toBeDefined();
        }),
    },
    {
        ...
        run: withClient({ tools: ['actors'] }, async (client) => {
            ...
            expect(sc === null || sc === void 0 ? void 0 : sc.nextStep).toContain((_d = (_c = (_b = (_a = sc === null || sc === void 0 ? void 0 : sc.storages) === null || _a === void 0 ? void 0 : _a.datasets) === null || _b === void 0 ? void 0 : _b.default) === null || _c === void 0 ? void 0 : _c.id) !== null && _d !== void 0 ? _d : '__unset__');
        }),
    },
    {
        ...
        run: withClient({ tools: ['actors'] }, async (client) => {
            ...
            expect((_c = (_b = (_a = sc === null || sc === void 0 ? void 0 : sc.storages) === null || _a === void 0 ? void 0 : _a.datasets) === null || _b === void 0 ? void 0 : _b.default) === null || _c === void 0 ? void 0 : _c.id).toBeDefined();
            expect((_f = (_e = (_d = sc === null || sc === void 0 ? void 0 : sc.storages) === null || _d === void 0 ? void 0 : _d.datasets) === null || _e === void 0 ? void 0 : _e.books) === null || _f === void 0 ? void 0 : _f.id).toEqual(expect.any(String));
        }),
    },
    {
    ...
    },
    {
        ...
        run: withClient({ tools: ['actors'] }, async (client) => {
            ...
            validateStructuredOutput(result, (_a = findToolByName(HELPER_TOOLS.ACTOR_GET_DETAILS, 'default')) === null || _a === void 0 ? void 0 : _a.outputSchema, 'fetch-actor-details');
        }),
    },
    {
    ...
    },
    {
        ...
        run: withClient({ tools: ['actors'] }, async (client) => {
            ...
            const resultWithStructured = result;
            expect(resultWithStructured.structuredContent).toBeDefined();
            expect((_a = resultWithStructured.structuredContent) === null || _a === void 0 ? void 0 : _a.actorInfo).toBeDefined();
            expect((_b = resultWithStructured.structuredContent) === null || _b === void 0 ? void 0 : _b.inputSchema).toBeDefined();
    ...
    },
    {
        ...
        run: withClient({ tools: ['actors'] }, async (client) => {
            ...
            const pricingContent = pricingOnlyResult.content;
            ...
            const ratingContent = ratingOnlyResult.content;
            ...
            const metadataContent = metadataOnlyResult.content;
            ...
            const combinationContent = combinationResult.content;
    ...
    },
    {
        ...
        run: withClient({ tools: ['actors'] }, async (client) => {
            ...
            const allCardContent = allCardSectionsResult.content;
    ...
    },
    {
        ...
        run: withClient({ tools: ['actors', 'runs'] }, async (client) => {
            ...
            const resultWithStructured = callResult;
            expect((_a = resultWithStructured.structuredContent) === null || _a === void 0 ? void 0 : _a.runId).toBeDefined();
    ...
    },
    {
        ...
        run: withClient(undefined, async (client, ctx) => {
            ...
            const contentByName = resultByName.content;
            ...
            const contentById = resultById.content;
    ...
    },
    {
        ...
        run: withClient({ tools: ['actors', 'runs'] }, async (client) => {
            ...
            const runContent = runResult;
            expect(runContent.structuredContent).toBeDefined();
            expect((_a = runContent.structuredContent) === null || _a === void 0 ? void 0 : _a.runId).toBe(runId);
            expect((_b = runContent.structuredContent) === null || _b === void 0 ? void 0 : _b.actorId).toBeDefined();
            expect((_c = runContent.structuredContent) === null || _c === void 0 ? void 0 : _c.status).toBeDefined();
            expect((_d = runContent.structuredContent) === null || _d === void 0 ? void 0 : _d.summary).toBeDefined();
            expect((_e = runContent.structuredContent) === null || _e === void 0 ? void 0 : _e.nextStep).toBeDefined();
            expect((_f = runContent.structuredContent) === null || _f === void 0 ? void 0 : _f.storages).toBeDefined();
            ...
            if (((_g = runContent.structuredContent) === null || _g === void 0 ? void 0 : _g.status) === 'SUCCEEDED') {
                expect((_j = (_h = runContent.structuredContent) === null || _h === void 0 ? void 0 : _h.storages.datasets) === null || _j === void 0 ? void 0 : _j.default.id).toBeDefined();
            }
        }),
    },
    {
...
//# sourceMappingURL=actors.cases.js.map
//# debugId=1bda4be1-7c24-5966-a2ed-4d1f871fc17c
