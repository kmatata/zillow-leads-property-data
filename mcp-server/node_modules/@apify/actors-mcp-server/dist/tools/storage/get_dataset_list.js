...
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="e6b4de79-ded5-5e6f-a5f0-6147a50cad7a")}catch(e){}}();
...
const getUserDatasetsListArgs = z.object({
    ...
    desc: z
        .boolean()
        .describe('If true or 1 then the datasets are sorted by the createdAt field in descending order. Default is false (ascending order).')
        .default(false),
    unnamed: z
        .boolean()
 ...
 */
export const getDatasetList = Object.freeze({
    type: TOOL_TYPE.INTERNAL,
    name: HELPER_TOOLS.DATASET_LIST_GET,
    title: 'Get user datasets list',
    description: buildDescription(ALL_TOOLS_PRESENT),
    buildDescription,
    inputSchema: z.toJSONSchema(getUserDatasetsListArgs),
...
//# sourceMappingURL=get_dataset_list.js.map
//# debugId=e6b4de79-ded5-5e6f-a5f0-6147a50cad7a
