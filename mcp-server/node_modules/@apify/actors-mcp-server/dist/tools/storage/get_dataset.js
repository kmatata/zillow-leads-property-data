...
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="b4f4ad8f-7b01-59c8-8bf5-c55ea19405dc")}catch(e){}}();
 ...
 */
export const getDataset = Object.freeze({
    type: TOOL_TYPE.INTERNAL,
    name: HELPER_TOOLS.DATASET_GET,
    title: 'Get dataset',
    description: buildDescription(ALL_TOOLS_PRESENT),
    buildDescription,
    inputSchema: z.toJSONSchema(getDatasetArgs),
    ...
    call: async (toolArgs) => {
        ...
        const inflatedBytes = (_a = dataset.stats) === null || _a === void 0 ? void 0 : _a.inflatedBytes;
        const summary = `Dataset '${(_b = normalized.name) !== null && _b !== void 0 ? _b : datasetId}' has ${(_c = normalized.itemCount) !== null && _c !== void 0 ? _c : 0} items${fieldCount !== undefined ? `, ${fieldCount} fields` : ''}.`;
...
//# debugId=b4f4ad8f-7b01-59c8-8bf5-c55ea19405dc
