...
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="b3d21a4d-52be-5074-90f9-feb4c6f44fad")}catch(e){}}();
...
import { buildBinaryRecordDisposition, buildConsoleLinkContent, buildStorageResponse, normalizeRecordKey, } from './storage_helpers.js';
 ...
 */
export const getKeyValueStoreRecord = Object.freeze({
    ...
    call: async (toolArgs) => {
        ...
        const apifyConsoleUrl = buildConsoleKeyValueStoreUrl(await getConsoleLinkContext(apifyToken, client), keyValueStoreId);
        ...
        if (Buffer.isBuffer(value)) {
            ...
            const structuredContent = {
                keyValueStoreId,
                key: record.key,
                value: `<binary ${mimeType !== null && mimeType !== void 0 ? mimeType : 'application/octet-stream'}, ${value.length} bytes>`,
            ...
            if (mimeType === null || mimeType === void 0 ? void 0 : mimeType.startsWith('image/')) {
                return respondRaw({
                    structuredContent,
                    content: [{ type: 'image', data, mimeType }, ...consoleLinkContent],
                });
            }
            if (mimeType === null || mimeType === void 0 ? void 0 : mimeType.startsWith('audio/')) {
                return respondRaw({
                    structuredContent,
                    content: [{ type: 'audio', data, mimeType }, ...consoleLinkContent],
                });
            }
...
//# sourceMappingURL=get_key_value_store_record.js.map
//# debugId=b3d21a4d-52be-5074-90f9-feb4c6f44fad
