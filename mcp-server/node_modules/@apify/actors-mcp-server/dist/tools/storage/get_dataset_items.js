...
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="3b84e2c8-1c1f-5192-ba70-7f8f85bef4a5")}catch(e){}}();
...
export function extractDotPrefixes(fields) {
 ...
 */
export const getDatasetItems = Object.freeze({
    ...
    inputSchema: z.toJSONSchema(getDatasetItemsArgs),
    ...
    call: async (toolArgs) => {
        ...
        const flatten = parsed.flatten !== undefined ? parseCommaSeparatedList(parsed.flatten) : extractDotPrefixes(fields);
        const effectiveLimit = (_a = parsed.limit) !== null && _a !== void 0 ? _a : DEFAULT_DATASET_ITEMS_LIMIT;
        ...
        const offset = (_b = parsed.offset) !== null && _b !== void 0 ? _b : 0;
...
//# sourceMappingURL=get_dataset_items.js.map
//# debugId=3b84e2c8-1c1f-5192-ba70-7f8f85bef4a5
