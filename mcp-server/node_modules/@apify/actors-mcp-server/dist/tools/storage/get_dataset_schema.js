...
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="8850ef1a-85e5-54a0-8ef9-d6d8dce07f3c")}catch(e){}}();
 ...
 */
export const getDatasetSchema = Object.freeze({
    type: TOOL_TYPE.INTERNAL,
    name: HELPER_TOOLS.DATASET_SCHEMA_GET,
    title: 'Get dataset schema',
    description: buildDescription(ALL_TOOLS_PRESENT),
    buildDescription,
    inputSchema: z.toJSONSchema(getDatasetSchemaArgs),
    ...
    call: async (toolArgs) => {
        ...
        const datasetResponse = await catchNotFound(client.dataset(datasetId).listItems({ clean: parsed.clean, limit: parsed.limit }));
        if (!datasetResponse) {
        ...
        const fieldCount = Object.keys((_a = schema.items.properties) !== null && _a !== void 0 ? _a : {}).length;
...
//# sourceMappingURL=get_dataset_schema.js.map
//# debugId=8850ef1a-85e5-54a0-8ef9-d6d8dce07f3c
