...
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="ff13320c-4b9d-5b7b-b6c5-6f0caf75ca86")}catch(e){}}();
 ...
 */
export function getCategoryTools(mode = SERVER_MODE.DEFAULT) {
    return Object.fromEntries(CATEGORY_NAMES.map((name) => [name, resolveCategoryEntries(toolCategories[name], mode)]));
}
export const toolCategoriesEnabledByDefault = ['actors', 'docs'];
/**
...
//# debugId=ff13320c-4b9d-5b7b-b6c5-6f0caf75ca86
