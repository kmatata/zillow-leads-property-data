...
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="58ecb57b-8ba5-527c-ae3a-3724b952cda7")}catch(e){}}();
import { z } from 'zod';
 ...
 */
function buildDocSourceDescription() {
...
const searchApifyDocsToolArgsSchema = z.object({
    docSource: z
        .enum(DOCS_SOURCES.map((source) => source.id))
        .optional()
        .default('apify')
...
export const searchApifyDocs = Object.freeze({
...
//# sourceMappingURL=search_apify_docs.js.map
//# debugId=58ecb57b-8ba5-527c-ae3a-3724b952cda7
