...
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="d269b13e-c857-5117-8d55-06a1cb09eb1a")}catch(e){}}();
import { z } from 'zod';
 ...
 */
export function buildMarkdownUrl(url) {
...
const ALLOWED_DOC_HOSTS = new Set(ALLOWED_DOC_DOMAINS.map((d) => new URL(d).hostname));
...
export function isAllowedDocsUrl(url) {
    let parsed;
    try {
        parsed = new URL(url);
    }
...
export const fetchApifyDocs = Object.freeze({
    ...
    call: async (toolArgs) => {
        ...
        if (!isAllowedDomain) {
            ...
            return respondUserError(`Invalid URL: "${url}". \
        ...
        if (!markdown) {
            ...
            try {
                ...
                if (!response.ok) {
                    ...
                    return respondServerError(buildFetchErrorMessage(url, `HTTP Status: ${response.status} ${response.statusText}.`), { error });
                }
                ...
                return respondServerError(buildFetchErrorMessage(url, `Error: ${error instanceof Error ? error.message : String(error)}.`), { error });
            }
        }
...
//# sourceMappingURL=fetch_apify_docs.js.map
//# debugId=d269b13e-c857-5117-8d55-06a1cb09eb1a
