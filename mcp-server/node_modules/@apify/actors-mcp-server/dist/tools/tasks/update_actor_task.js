...
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="b4482830-1e7c-56f4-a9a0-7c6ca61a1067")}catch(e){}}();
import { z } from 'zod';
...
import { getTaskByIdOrName, isAmbiguousResourceId, publicConfigSchema, taskNameSchema, taskResult, toSafeResourceId, } from './task_helpers.js';
const updateActorTaskArgs = z.object({
    taskId: z
        .string()
        .min(1)
        .describe('The task to update: its ID, its name (resolved against your own tasks), or "username/task-name" for a task owned by someone else.'),
    ...
    publicConfig: publicConfigSchema
        .optional()
        .describe('Public display configuration of the task landing page. Provided fields are merged into the stored configuration; the publication state itself is not changed here.'),
});
function buildDescription({ hasTool }) {
    const publicationTools = [HELPER_TOOLS.ACTOR_TASK_PUBLISH, HELPER_TOOLS.ACTOR_TASK_UNPUBLISH].filter((name) => hasTool(name));
 ...
 */
export const updateActorTask = Object.freeze({
    type: TOOL_TYPE.INTERNAL,
    name: HELPER_TOOLS.ACTOR_TASK_UPDATE,
    title: 'Update Actor task',
    description: buildDescription(ALL_TOOLS_PRESENT),
    buildDescription,
    inputSchema: z.toJSONSchema(updateActorTaskArgs),
    ...
    call: async (toolArgs) => {
        ...
        const { taskId, name, title, description, input, build, timeoutSecs, memoryMbytes, publicConfig } = updateActorTaskArgs.parse(args);
        const optionsUpdate = {
...
//# sourceMappingURL=update_actor_task.js.map
//# debugId=b4482830-1e7c-56f4-a9a0-7c6ca61a1067
