...
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="d274b17c-da3f-5127-bdf1-bd4e452c1e32")}catch(e){}}();
import { z } from 'zod';
...
const unpublishActorTaskArgs = z.object({
    taskId: z
        .string()
        .min(1)
        .describe('The task to unpublish: its ID, its name (resolved against your own tasks), or "username/task-name" for a task owned by someone else.'),
});
 ...
 */
export const unpublishActorTask = Object.freeze({
    type: TOOL_TYPE.INTERNAL,
    name: HELPER_TOOLS.ACTOR_TASK_UNPUBLISH,
    title: 'Unpublish Actor task',
    description: buildDescription(ALL_TOOLS_PRESENT),
    buildDescription,
    inputSchema: z.toJSONSchema(unpublishActorTaskArgs),
...
//# sourceMappingURL=unpublish_actor_task.js.map
//# debugId=d274b17c-da3f-5127-bdf1-bd4e452c1e32
