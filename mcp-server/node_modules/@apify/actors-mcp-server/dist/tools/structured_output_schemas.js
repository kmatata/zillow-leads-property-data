...
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="64cac1ea-6fea-5dee-935d-832bb0c88fb1")}catch(e){}}();
...
export const actorInfoSchema = {
    ...
    properties: {
        ...
        inputFieldsTruncated: {
            type: 'boolean',
            description: 'Present and `true` when `inputFields` was truncated; fetch the full schema via `fetch-actor-details`.',
        },
        inputFieldsTotalCount: {
            type: 'number',
            description: 'Total number of input fields before truncation; present only when `inputFields` was truncated.',
        },
    },
...
export function buildEnrichedDirectActorOutputSchema(itemProperties) {
    ...
    const datasetDefaultProps = clone.properties.storages.properties.datasets.properties.default.properties;
 ...
 */
function paginatedListOutputSchema(itemsSchema, itemsDescription) {
    return {
        type: 'object',
        properties: {
            ...
            items: { type: 'array', items: itemsSchema, description: itemsDescription },
        },
...
const actorRunListItemSchema = {
    ...
    properties: {
        ...
        status: {
            type: 'string',
            description: 'Run status: READY | RUNNING | SUCCEEDED | FAILED | TIMING-OUT | TIMED-OUT | ABORTING | ABORTED.',
        },
...
export const datasetSchemaOutputSchema = {
    ...
    properties: {
        datasetId: { type: 'string', description: 'Dataset ID' },
        schema: { type: 'object', description: 'Inferred JSON schema describing dataset item structure' },
        summary: summaryProperty,
        nextStep: nextStepProperty,
    },
...
//# debugId=64cac1ea-6fea-5dee-935d-832bb0c88fb1
