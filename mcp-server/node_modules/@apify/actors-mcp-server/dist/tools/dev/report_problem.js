...
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="ef6326a5-4e0b-5abe-b1d9-f3e2c42ac62b")}catch(e){}}();
import { z } from 'zod';
 ...
 */
const NON_NUDGE_FAILURE_CATEGORIES = new Set([
 ...
 * otherwise.
 */
export function appendReportProblemNudge(result, opts) {
    if (!opts.available)
        return result;
    if (opts.failingToolName === HELPER_TOOLS.PROBLEM_REPORT)
        return result;
    if (opts.failureHttpStatus === 402)
        return result; // payment required: billing state, not a defect
    if (opts.failureCategory !== undefined && NON_NUDGE_FAILURE_CATEGORIES.has(opts.failureCategory))
        return result;
    const r = result;
    if ((r === null || r === void 0 ? void 0 : r.isError) !== true || !Array.isArray(r.content))
        return result;
    const nudge = opts.failureCategory === FAILURE_CATEGORY.INVALID_INPUT
        ? REPORT_PROBLEM_INVALID_INPUT_NUDGE
        : REPORT_PROBLEM_NUDGE;
    return { ...r, content: [...r.content, { type: 'text', text: nudge }] };
}
/**
 ...
 * the helper.
 */
export function withReportProblemNudge(params) {
...
const reportProblemInputSchema = z.toJSONSchema(reportProblemArgsSchema);
export const reportProblem = Object.freeze({
...
//# sourceMappingURL=report_problem.js.map
//# debugId=ef6326a5-4e0b-5abe-b1d9-f3e2c42ac62b
