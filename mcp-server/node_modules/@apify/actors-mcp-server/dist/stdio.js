...
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="14d942fa-6419-54f2-bbda-e6ed6978b190")}catch(e){}}();
var _a;
...
const packageVersion = (_a = getPackageVersion()) !== null && _a !== void 0 ? _a : '0.0.0';
...
Default: true (enabled)`,
    ...
    hidden: true,
    coerce: (arg) => arg === null || arg === void 0 ? void 0 : arg.toUpperCase(),
...
--ui auto (default)               : resolve from client capabilities`,
    ...
    .epilogue('To connect, set your MCP client server command to `npx @apify/actors-mcp-server`' +
...
async function main() {
    ...
    if (major < 22) {
        // eslint-disable-next-line no-console
        console.error(`Error: Apify MCP server requires Node.js 22 or later (you have ${process.version}).\n` +
    ...
    transport.onmessage = (message) => {
        ...
        msgRecord.params = injectMcpSessionId(msgRecord.params, mcpSessionId);
...
//# debugId=14d942fa-6419-54f2-bbda-e6ed6978b190
