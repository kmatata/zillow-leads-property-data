...
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="a819ed67-8fcd-50ea-8e4f-8512d9f412fa")}catch(e){}}();
...
const SEGMENT_FLUSH_INTERVAL_MS = 5000;
 ...
 */
export function buildReportedProblemProperties(context, args) {
    const { message, actorId, actorRunId, relatedTools } = args;
    return {
        app: context.app,
 ...
 */
export function trackReportedProblem(userId, telemetryEnv, properties) {
    const client = getOrInitAnalyticsClient(telemetryEnv);
    try {
        client === null || client === void 0 ? void 0 : client.track({
            ...(userId ? { userId } : { anonymousId: properties.mcp_session_id || crypto.randomUUID() }),
...
//# debugId=a819ed67-8fcd-50ea-8e4f-8512d9f412fa
